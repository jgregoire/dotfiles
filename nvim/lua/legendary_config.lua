...
require('legendary').setup({
	...
	{ '<C-s>', ':w<CR>', mode = { 'n' },      description = 'Save file', defaults },
        { '<C-v>', 'v',      mode = { 'n' },      description = 'Paste after cursor', defaults },
	{ '<C-v>', '<C-r>\"',mode = { 'i' },      description = 'Paste from \" register', defaults },
        { '<C-w>',           mode = { 'i' },      description = 'Delete word before cursor', defaults },
        ...
        { 'l', 'h', mode = { 'o' }, description = 'Character to left', defaults },
